...
function App() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/classificacao`).then(res => res.json()).then(setClassificacao);
    fetch(`${API_URL}/api/calendario`).then(res => res.json()).then(setCalendario);
    fetch(`${API_URL}/api/estatisticas`).then(res => res.json()).then(setStats);
}, []);
